...
def generate_file_paths(base_path, scan_type, num_subjects=30):
    ...
    for subject_id in subject_ids:
        file_path = os.path.join(base_path, subject_id, f'{subject_id}_tfMRI_WM_{scan_type}_100')
...
tau =.01  # Adjusted regularization parameter
...
plt.legend()
plt.grid(True)
plot_file_path = '/mmfs1/home/mzu0014/project1/id_rates_wm1_across_z_values.png'
...
output_file_path = "/mmfs1/home/mzu0014/project1/id_rate_az_divwm1_results.txt"
