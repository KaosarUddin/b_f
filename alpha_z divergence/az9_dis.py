...
def generate_file_paths(base_path, scan_type, num_subjects=428):
    ...
    for subject_id in subject_ids:
        file_path = os.path.join(base_path, subject_id, f'{subject_id}_tfMRI_MOTOR_{scan_type}_200')
...
results_path = "/mmfs1/home/mzu0014/project1/identification_rates_az(200)_motor(.99,1).txt"
