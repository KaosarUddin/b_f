...
def generate_file_paths(base_path, scan_type, num_subjects=428):
    ...
    for subject_id in subject_ids:
        file_path = os.path.join(base_path, subject_id, f'{subject_id}_rfMRI_REST1_{scan_type}_600')
...
yeo_rois_path = '/mmfs1/home/mzu0014/updated_LUT/updated_LUT/YeoROIs_N600.mat' # Replace with actual path
...
output_file = '/mmfs1/home/mzu0014/project1/id_rates_az(600)_(7N_combined_region)_rest.txt'
