...
tau_values = [0,.001,.01] # Different regularization strengths to test
...
output_file = '/mmfs1/home/mzu0014/project1/id_rates_le_relational(900)_tao.txt'  # Change this to your preferred path on the server
