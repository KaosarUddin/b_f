...
tau_values = [42] # Different regularization strengths to test
...
output_file = '/mmfs1/home/mzu0014/project1/id_rates_le(428)_language(700)_tao.txt'  # Change this to your preferred path on the server
