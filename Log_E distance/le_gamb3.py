...
def generate_file_paths(base_path, scan_type, num_subjects=428):
    ...
    for subject_id in subject_ids:
        file_path = os.path.join(base_path, subject_id, f'{subject_id}_tfMRI_GAMBLING_{scan_type}_300')
...
output_file = '/mmfs1/home/mzu0014/project1/id_rates_le(428)_300_gambling_tao.txt'  # Change this to your preferred path on the server
