...
tau_values =[22,44]  # Different regularization strengths to test
...
output_file = '/mmfs1/home/mzu0014/project1/id_rates_ai(428S)_social400_tao.txt'  # Change this to your preferred path on the server
