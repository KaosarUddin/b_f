...
tau_values = [0,5,10,12,16,20,22,,24,26,28,30,36,40]  # Different regularization strengths to test
...
output_file = '/mmfs1/home/mzu0014/project1/id_rates_ai(100S)_rest700_tao.txt'  # Change this to your preferred path on the server
