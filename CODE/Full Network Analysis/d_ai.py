...
print(f"Final ID Rate for rank_1: {final_id_rate}")
...
# Compute the final ID rate as the mean of the two ID rates
final_id_rate = (id_rate_three_closest_1 + id_rate_three_closest_2) / 2
print(f"ID Rate 1: {id_rate_three_closest_1}")
print(f"ID Rate 2: {id_rate_three_closest_2}")
print(f"Final ID Rate for rank_3: {final_id_rate}")
...
print(f"ID Rate 1: {id_rate_three_closest_1}")
print(f"ID Rate 2: {id_rate_three_closest_2}")
print(f"Final ID Rate for rank_5: {final_id_rate}")
np.savetxt("log_euclidean_distance_matrix_1.csv", bw_distance_matrix_1, delimiter=",")
#bw_distance_matrix_1 and bw_distance_matrix_2 are your distance matrices
...
axes[0].set_title("BW Distance Matrix Heatmap 1")
...
axes[1].set_title("BW Distance Matrix Heatmap 2")
