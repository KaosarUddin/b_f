...
def distance_matrix(connectivity_matrices_1, connectivity_matrices_2, alpha, z,tau=.01):
...
for alpha in alpha_values:
    ...
    id_rates_for_alpha = []
    for z in z_values:
        distance_matrix_1 = distance_matrix(connectivity_matrices_lr, connectivity_matrices_rl, alpha, z,tau=tau)
        id_rate_1 = compute_id_rate(distance_matrix_1)
        
        distance_matrix_2 = distance_matrix(connectivity_matrices_rl, connectivity_matrices_lr, alpha, z,tau=tau)
