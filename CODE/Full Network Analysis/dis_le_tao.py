...
tau_values = [.01, .1]  # Different regularization strengths to test
...
output_file_path = '/mmfs1/home/mzu0014/project1/id_rate_results_dis_le_tao.txt'
...
plt.legend()
plt.grid(True)
plot_file_path = '/mmfs1/home/mzu0014/project1/id_rates_le_tao_values.png'
